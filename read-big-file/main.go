...
func main_file() {
	...
	queryStartTime, err := time.Parse("2006-01-02T15:04:05.00", startTimeArg)
	if err != nil {
		fmt.Println("Could not able to parse the start time", startTimeArg)
		return
	}

	queryFinishTime, err := time.Parse("2006-01-02T15:04:05.00", finishTimeArg)
	if err != nil {
		fmt.Println("Could not able to parse the end time", finishTimeArg)
		return
	}
